...
const INITIAL_EMPLOYEES: Employee[] = [
  ...
  { id:'e4',  name:'سارة طارق حجازي',        role:'accountant',   jobTitle:'محاسبة قانونية',        nationalId:'30102091504238', address:'القاهرة، الزيتون، شارع العروبة',               department:'الحسابات والمالية', phone:'01012468135', email:'sara@negmfarm.com',     basicSalary:12000, insurance:1200, taxes:360,  workStart:'2022-01-10', workEnd:'',           status:'active',   notes:'مسؤولة عن الميزانية والحسابات الختامية',                  avatar:'س' },
  { id:'e5',  name:'عمر رمضان درويش',        role:'warehouse',    jobTitle:'مسئول مخزن',            nationalId:'30005110602467', address:'القاهرة، شبرا، شارع الترجمان',                 department:'المخزن',            phone:'01551357924', email:'omar@negmfarm.com',     basicSalary:5500,  insurance:550,  taxes:165,  workStart:'2022-04-05', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ع' },
  { id:'e6',  name:'فاطمة محمد البدوي',       role:'accountant',   jobTitle:'محاسبة',                nationalId:'30308131704519', address:'الجيزة، الدقي، شارع البطل أحمد عبدالعزيز',     department:'الحسابات والمالية', phone:'01008642097', email:'fatima@negmfarm.com',   basicSalary:9500,  insurance:950,  taxes:285,  workStart:'2022-07-18', workEnd:'',           status:'on_leave', notes:'في إجازة أمومة حتى نهاية الربع الثالث',                   avatar:'ف' },
  { id:'e7',  name:'مصطفى سامي منصور',       role:'purchasing',   jobTitle:'مسئول مشتريات',         nationalId:'29803050805623', address:'القاهرة، المطرية، شارع صلاح سالم',             department:'المشتريات',         phone:'01203216549', email:'mostafa@negmfarm.com',  basicSalary:7500,  insurance:750,  taxes:225,  workStart:'2023-02-28', workEnd:'',           status:'active',   notes:'مسؤول عن توريد مستلزمات المزرعة والأعلاف',               avatar:'م' },
  { id:'e8',  name:'هاني فريد عوض',          role:'warehouse',    jobTitle:'أمين مخزن',             nationalId:'30110170906715', address:'القاهرة، عين شمس، شارع مصطفى النحاس',         department:'المخزن',            phone:'01006549873', email:'hany@negmfarm.com',     basicSalary:4800,  insurance:480,  taxes:144,  workStart:'2023-05-11', workEnd:'2025-01-31', status:'inactive', notes:'انتهت عقدته ولم يتم التجديد',                             avatar:'ه' },
  { id:'e9',  name:'نور إبراهيم طه',         role:'manager',      jobTitle:'مديرة إنتاج',           nationalId:'30007191007528', address:'القاهرة، مدينة نصر، حي السفارات',              department:'الإدارة العامة',    phone:'01024561237', email:'nour@negmfarm.com',     basicSalary:15000, insurance:1500, taxes:450,  workStart:'2023-08-01', workEnd:'',           status:'active',   notes:'مسؤولة عن متابعة معدلات الإنتاج اليومي',                 avatar:'ن' },
  { id:'e10', name:'ياسر سعد حافظ',          role:'warehouse',    jobTitle:'مسئول مخزن',            nationalId:'29906222008836', address:'القاهرة، المعصرة، شارع النصر',                 department:'المخزن',            phone:'01507891234', email:'yasser@negmfarm.com',   basicSalary:6000,  insurance:600,  taxes:180,  workStart:'2024-01-15', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ي' },
  { id:'e11', name:'دينا عمر الجندي',        role:'accountant',   jobTitle:'مختصة مالية',           nationalId:'30211231309748', address:'الإسكندرية، محرم بك، شارع الحرية',             department:'الحسابات والمالية', phone:'01006667788', email:'dina@negmfarm.com',     basicSalary:11000, insurance:1100, taxes:330,  workStart:'2024-02-10', workEnd:'',           status:'active',   notes:'',                                                        avatar:'د' },
  { id:'e12', name:'طارق محمد زيدان',        role:'warehouse',    jobTitle:'أمين مخزن أعلاف',       nationalId:'30104260110857', address:'الجيزة، الشيخ زايد، الحي الأول',               department:'المخزن',            phone:'01209990011', email:'tarek@negmfarm.com',    basicSalary:5000,  insurance:500,  taxes:150,  workStart:'2024-03-01', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ط' },
  { id:'e13', name:'رانيا خالد شلبي',        role:'manager',      jobTitle:'مديرة جودة',            nationalId:'30009310511968', address:'القاهرة، الهرم، طريق الفيوم',                  department:'الإدارة العامة',    phone:'01002223344', email:'rania@negmfarm.com',    basicSalary:14000, insurance:1400, taxes:420,  workStart:'2024-04-15', workEnd:'',           status:'on_leave', notes:'إجازة صيفية حتى سبتمبر',                                  avatar:'ر' },
  { id:'e14', name:'وائل حسن القاضي',        role:'purchasing',   jobTitle:'مسئول توريد',           nationalId:'29811350212079', address:'المنصورة، حي الجامعة، شارع الجيش',              department:'المشتريات',         phone:'01505556677', email:'wael@negmfarm.com',     basicSalary:7000,  insurance:700,  taxes:210,  workStart:'2024-05-20', workEnd:'',           status:'active',   notes:'',                                                        avatar:'و' },
  { id:'e15', name:'منى سامي الغزالي',       role:'veterinarian', jobTitle:'دكتورة بيطرية',         nationalId:'30106410713189', address:'الجيزة، 6 أكتوبر، الحي الصناعي',               department:'الرعاية البيطرية',  phone:'01008889900', email:'mona@negmfarm.com',     basicSalary:16000, insurance:1600, taxes:480,  workStart:'2024-06-05', workEnd:'',           status:'active',   notes:'متخصصة في التطعيمات والوقاية',                            avatar:'م' },
  { id:'e16', name:'إبراهيم علي مسعود',      role:'warehouse',    jobTitle:'أمين مخزن',             nationalId:'29907480414297', address:'القاهرة، شبرا الخيمة، شارع إبراهيم الأول',    department:'المخزن',            phone:'01201112233', email:'ibrahim@negmfarm.com',  basicSalary:5200,  insurance:520,  taxes:156,  workStart:'2024-07-01', workEnd:'2025-02-28', status:'inactive', notes:'غادر العمل بصورة مفاجئة',                                 avatar:'إ' },
  { id:'e17', name:'شيرين أحمد سلامة',       role:'accountant',   jobTitle:'محللة مالية',           nationalId:'30112540615308', address:'القاهرة، مصر الجديدة، شارع مكرم عبيد',         department:'الحسابات والمالية', phone:'01004445566', email:'shirin@negmfarm.com',   basicSalary:13000, insurance:1300, taxes:390,  workStart:'2024-08-15', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ش' },
  { id:'e18', name:'كريم عاطف مرسي',         role:'warehouse',    jobTitle:'مسئول مخزن صيانة',      nationalId:'30003610817419', address:'القاهرة، المعادي الكبرى، شارع 9',              department:'المخزن',            phone:'01507778899', email:'karim2@negmfarm.com',   basicSalary:5800,  insurance:580,  taxes:174,  workStart:'2024-09-01', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ك' },
  { id:'e19', name:'هناء طارق حجاب',         role:'manager',      jobTitle:'مديرة إدارية',          nationalId:'30208711019527', address:'الجيزة، الدقي، شارع أحمد عرابي',               department:'الإدارة العامة',    phone:'01000001122', email:'hanaa@negmfarm.com',    basicSalary:15000, insurance:1500, taxes:450,  workStart:'2024-10-10', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ه' },
  { id:'e20', name:'عادل نبيل برعي',         role:'warehouse',    jobTitle:'أمين مخزن',             nationalId:'30007910220638', address:'القاهرة، المطرية، شارع ترعة الإسماعيلية',      department:'المخزن',            phone:'01203334455', email:'adel@negmfarm.com',     basicSalary:5000,  insurance:500,  taxes:150,  workStart:'2024-11-01', workEnd:'',           status:'on_leave', notes:'إجازة اضطرارية',                                          avatar:'ع' },
  { id:'e21', name:'ياسمين سيد عيسى',        role:'accountant',   jobTitle:'محاسبة رواتب',          nationalId:'30302121421749', address:'القاهرة، عابدين، شارع بور سعيد',               department:'الحسابات والمالية', phone:'01006667890', email:'yasmine@negmfarm.com',  basicSalary:9000,  insurance:900,  taxes:270,  workStart:'2024-11-20', workEnd:'',           status:'active',   notes:'مسؤولة عن مسير رواتب الموظفين',                          avatar:'ي' },
  { id:'e22', name:'حسام محمد البدوي',        role:'purchasing',   jobTitle:'مسئول مشتريات',         nationalId:'29811220622857', address:'الجيزة، الشيخ زايد، كمبوند زايد 2000',        department:'المشتريات',         phone:'01009990123', email:'hossam@negmfarm.com',   basicSalary:6500,  insurance:650,  taxes:195,  workStart:'2024-12-01', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ح' },
  { id:'e23', name:'إيمان فريد زغلول',       role:'veterinarian', jobTitle:'مساعدة دكتور بيطري',    nationalId:'30106520824966', address:'القاهرة، مدينة نصر، شارع مكرم عبيد',           department:'الرعاية البيطرية',  phone:'01502223344', email:'eman@negmfarm.com',     basicSalary:9000,  insurance:900,  taxes:270,  workStart:'2025-01-05', workEnd:'',           status:'active',   notes:'',                                                        avatar:'إ' },
  { id:'e24', name:'علي عبدالرحمن رفاعي',    role:'purchasing',   jobTitle:'مسئول توريد',           nationalId:'29901620227074', address:'القاهرة، حلوان، شارع الصناعة',                 department:'المشتريات',         phone:'01005556789', email:'ali@negmfarm.com',      basicSalary:6200,  insurance:620,  taxes:186,  workStart:'2025-02-14', workEnd:'2025-09-30', status:'inactive', notes:'عقد مؤقت انتهى',                                          avatar:'ع' },
  { id:'e25', name:'نادية وائل رزق',         role:'warehouse',    jobTitle:'أمينة مخزن',            nationalId:'30203720429182', address:'القاهرة، الزيتون، شارع الجيش',                 department:'المخزن',            phone:'01208889900', email:'nadia@negmfarm.com',    basicSalary:5000,  insurance:500,  taxes:150,  workStart:'2025-03-01', workEnd:'',           status:'active',   notes:'',                                                        avatar:'ن' },
]
