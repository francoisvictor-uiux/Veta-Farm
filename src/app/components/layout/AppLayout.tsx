    ...
    <header className="h-[64px] bg-white border-b border-neutral-200 flex items-center gap-3 px-6 shrink-0 z-[200] relative" dir="rtl">
      ...
      <div className="relative">
        <button type="button" onClick={onToggleNotif}
          ...
          <Bell size={18} />
          {unreadCount > 0 && (
            <span className="absolute top-1 right-1 min-w-[16px] h-4 flex items-center justify-center bg-red-500 text-white font-cairo font-bold text-[9px] rounded-full px-1 leading-none">{unreadCount}</span>
          )}
        </button>
      ...
      <div className="relative">
        <button type="button" onClick={onToggleProfile}
